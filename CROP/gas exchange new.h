...
public:
	void SetVal(double PFD, const TInitInfo info, double Nitrogendeficiencyone, double Tair, double CO2, double RH, double wind, double Press, double width, double Tubmod, double Feedback, double leafage, double psil, double etsupply);
