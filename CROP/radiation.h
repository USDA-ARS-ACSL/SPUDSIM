...
private:
    int jday = 0;
	double time = 0., latitude = 0., longitude = 0., altitude = 0., tau = 0., solarRad = 0., PAR = 0., NIR = 0., halfday = 0., stdMeridian = 0.; // To do: incorporate the computation of global irradiance including NIR
