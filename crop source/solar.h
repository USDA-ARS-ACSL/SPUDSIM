...
private:
	...
	double PotentialPARDiffuse, PotentialPARDirect, PotentialPARTotal;				//PAR: photosynthesis Active Rad
	double PotentialNIRDiffuse, PotentialNIRDirect, PotentialNIRTotal;				//NIR: Near-Infrared Light Rad
	double SolarDirect, SolarDiffuse, FracDiffuse, PFDDirect, PFDDiffuse;			//PFD: photosynthetic flux density (umol photons m-2 s-1)
...
public:
	...
	//double GetFracNIRDiffuse() { return 1.0 - FracNIRDirect; }
